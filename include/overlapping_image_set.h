...
class OverlappingImageSet {
 public:
	OverlappingImageSet(const std::vector<ImageMetadata>& image_metadata, const Polygon_2& geo_face_polygon);
 ...
 private:
	...
	// the pairs of ImageMetadata (it should be sufficient to store the integer
